...
check_file "scripts/remote/run/check-image-cache-network.sh"
check_file "scripts/remote/run/prepare-image-cache-network.sh"
...
check_grep 'check-image-cache-network\.sh' "scripts/remote/run/run-image-cache-smoke.sh"
...
check_grep 'docker\.m\.daocloud\.io/library/busybox:latest' "scripts/remote/run/run-image-cache-smoke.sh"
check_grep 'COCO_NERDCTL_DNS:-192\.168\.31\.1' "scripts/remote/run/run-image-cache-smoke.sh"
check_grep 'COCO_NERDCTL_NET:-coco-bridge' "scripts/remote/run/run-image-cache-smoke.sh"
